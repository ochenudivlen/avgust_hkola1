...
/**
    ...
    \param[in] number is number for exact comparison
    */
...
/**
    ...
    ! This function determines the form of the equation and finds errors

    \param[in] coeff_a is leading coefficient
    \param[in] coeff_b is middle coefficient
    \param[in] coeff_c is free coefficient
    \param[out] solution is number of roots
    \param[out] result1 is first root
    \param[out] result2 is second root
    */
...
/**
    ...
    ! This function processes the coefficients
